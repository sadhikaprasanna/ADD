...
import { faHistory, faClipboard } from '@fortawesome/free-solid-svg-icons';
  ...
  const renderMenuContent = () => {
    switch (activeMenu) {
      ...
      default:
        return (
          <div>
            <p className='para1'>Welcome to the Medical Interface </p>
            <p className='para2'>Please Select an option from the left</p>
          </div>
        );
    }
  };
